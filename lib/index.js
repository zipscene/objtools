...
exports.getNotWhitelistedFields = function(obj, whitelist) {
	...
	function traverse(obj, whitelist, path) {
		...
		if(typeof obj != 'object' || !obj) { notWhitelisted.push(path); return; }
		for(var key in obj) {
			var val = obj[key];
			...
			if(typeof val != 'object' || typeof whitelistEntry != 'object' || !val) { notWhitelisted.push(subPath); continue; }
...
exports.checkWhitelistFields = function(fields, whitelist) {
	...
	if(typeof fields != 'object' || typeof whitelist != 'object') return false;
	for(var key in fields) {
		...
		if(typeof field == 'object' && typeof fieldWhitelist == 'object') {
...
exports.matchDocument = function(doc, query) {
	...
	if(typeof query != 'object' || typeof doc != 'object') return query === doc;
...
exports.inheritDocument = function() {
	...
	function merge(base, sub) {
		...
		if(sub === null || sub === undefined) return undefined;
			...
			if(typeof base != 'object') return merge(protoObj, sub);
...
exports.inheritDiff = function(base, result) {
	...
	if(typeof base == 'object' && typeof result == 'object') {
...
exports.getPath = function(obj, path, allowSkipArrays) {
	...
	var parts = path.split('.');
	for(var i = 0; i < parts.length; i++) {
		if(typeof cur != 'object' || !cur) return undefined;
