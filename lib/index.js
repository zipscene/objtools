...
function merge(object, ...sources) {
	...
	let isIterator = sources.length > 1 && Array.isArray(lastSource) && lastSource.indexOf(sources[0]) !== -1;
	if (isIterator) {
...
function baseMerge(object, source, customizer) {
	if (!isScalar(object)) {
		...
		// use _.keys for arrays to properly handle sparse arrays
